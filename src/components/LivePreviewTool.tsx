...
const LivePreviewTool = () => {
  ...
  // Default Items for each service type
  const defaultItemsByServiceType: Record<string, MenuItem[]> = {
    restaurant: [
      {
        id: 1,
        name: "ريش ضاني مدخنة",
                  ...
                  <div className="pt-3 border-t border-border">
                    ...
                    {customItems.length > 0 && (
                      <div className="mt-3 space-y-1.5">
                        <span className="text-[10px] font-semibold text-muted-foreground">{currentServiceType.itemLabel} المضافة:</span>
