...
export default function ClientMasterModal({ client, open, onOpenChange, onUpdate }: Props) {
  ...
  /* assets */
  const [brandConfig, setBrandConfig] = useState({ logo_url: client.logo_url || "", primary_color: client.primary_color || "#6366f1", secondary_color: client.secondary_color || "#8b5cf6" });
