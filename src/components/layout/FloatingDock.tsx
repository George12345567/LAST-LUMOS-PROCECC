...
const DockItem = ({
    ...
    return (
        <button
            ...
            className={`${baseClasses} ${variantClasses[variant]} ${highlighted ? highlightClasses : ""} ${variant === "default" || variant === "danger" ? "hover:scale-130 active:scale-95" : "hover:scale-115 active:scale-95"}`}
            aria-label={label}
        >
...
const FloatingDock = () => {
    ...
    const profileTabs: Array<{ id: ProfileTabId; label: string; icon: typeof Home }> = [
