      ...
      <div className="container mx-auto relative z-10">
        ...
        <div className="block md:hidden">
          ...
          <div className="flex items-center justify-center gap-4 mb-4 flex-wrap">
            <a href="#hero" className="text-muted-foreground hover:text-primary transition-colors text-sm">Home</a>
            <a href="#services" className="text-muted-foreground hover:text-primary transition-colors text-sm">Services</a>
            <a href="#process" className="text-muted-foreground hover:text-primary transition-colors text-sm">Process</a>
        ...
        {/* Desktop: Grid Layout */}
        <div className="hidden md:grid md:grid-cols-4 gap-6 sm:gap-8 mb-6 sm:mb-8">
          {/* Logo & Description */}
          ...
          <div>
            ...
            <div className="flex flex-col gap-3">
              ...
              >
                ...
                <span className="truncate">lomus.agency.contact@gmail.com</span>
              </a>
            </div>
          </div>
        </div>
